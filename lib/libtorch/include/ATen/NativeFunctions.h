...
CAFFE2_API Tensor _embedding_bag_per_sample_weights_backward_cpu(const Tensor & grad, const Tensor & weight, const Tensor & indices, const Tensor & offset2bag, int64_t mode);
CAFFE2_API Tensor _embedding_bag_per_sample_weights_backward_cuda(const Tensor & grad, const Tensor & weight, const Tensor & indices, const Tensor & offset2bag, int64_t mode);
...
CAFFE2_API std::tuple<Tensor,Tensor,Tensor> _unique_dim2_cpu(const Tensor & self, int64_t dim, bool sorted=true, bool return_inverse=false, bool return_counts=false);
CAFFE2_API std::tuple<Tensor,Tensor,Tensor> _unique_dim2_cuda(const Tensor & self, int64_t dim, bool sorted=true, bool return_inverse=false, bool return_counts=false);
...
CAFFE2_API Tensor quantize_linear(const Tensor & self, double scale, int64_t zero_point);
CAFFE2_API Tensor dequantize(const Tensor & self);
CAFFE2_API Scalar q_scale(const Tensor & self);
CAFFE2_API Scalar q_zero_point(const Tensor & self);
