...
struct CAFFE2_API TypeExtendedInterface : public Type {
  ...
  virtual Tensor _embedding_bag_per_sample_weights_backward(const Tensor & grad, const Tensor & weight, const Tensor & indices, const Tensor & offset2bag, int64_t mode) const = 0;
  ...
  virtual std::tuple<Tensor,Tensor,Tensor> _unique2_temporary_will_remove_soon(const Tensor & self, bool sorted, bool return_inverse, bool return_counts) const = 0;
  virtual std::tuple<Tensor,Tensor,Tensor> _unique_dim2_temporary_will_remove_soon(const Tensor & self, int64_t dim, bool sorted, bool return_inverse, bool return_counts) const = 0;
