...
class CAFFE2_API ModelDef : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:torch.ModelDef) */ {
 public:
  ...
  // optional .torch.LibDef libs = 9;
  bool has_libs() const;
  void clear_libs();
  static const int kLibsFieldNumber = 9;
  private:
  const ::torch::LibDef& _internal_libs() const;
  public:
  const ::torch::LibDef& libs() const;
  ::torch::LibDef* release_libs();
  ::torch::LibDef* mutable_libs();
  void set_allocated_libs(::torch::LibDef* libs);
...
// optional .torch.LibDef libs = 9;
inline bool ModelDef::has_libs() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void ModelDef::set_has_libs() {
  _has_bits_[0] |= 0x00000008u;
}
inline void ModelDef::clear_has_libs() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void ModelDef::clear_libs() {
  if (libs_ != NULL) libs_->Clear();
  clear_has_libs();
}
inline const ::torch::LibDef& ModelDef::_internal_libs() const {
  return *libs_;
}
inline const ::torch::LibDef& ModelDef::libs() const {
  const ::torch::LibDef* p = libs_;
  // @@protoc_insertion_point(field_get:torch.ModelDef.libs)
  return p != NULL ? *p : *reinterpret_cast<const ::torch::LibDef*>(
      &::torch::_LibDef_default_instance_);
}
inline ::torch::LibDef* ModelDef::release_libs() {
  // @@protoc_insertion_point(field_release:torch.ModelDef.libs)
  clear_has_libs();
  ::torch::LibDef* temp = libs_;
  libs_ = NULL;
  return temp;
}
inline ::torch::LibDef* ModelDef::mutable_libs() {
  set_has_libs();
  if (libs_ == NULL) {
    auto* p = CreateMaybeMessage<::torch::LibDef>(GetArenaNoVirtual());
    libs_ = p;
  }
  // @@protoc_insertion_point(field_mutable:torch.ModelDef.libs)
  return libs_;
}
inline void ModelDef::set_allocated_libs(::torch::LibDef* libs) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete libs_;
  }
  if (libs) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      libs = ::google::protobuf::internal::GetOwnedMessage(
          message_arena, libs, submessage_arena);
    }
    set_has_libs();
  } else {
    clear_has_libs();
  ...
  libs_ = libs;
  // @@protoc_insertion_point(field_set_allocated:torch.ModelDef.libs)
}
