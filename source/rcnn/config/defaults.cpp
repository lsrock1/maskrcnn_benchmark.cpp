...
YAML::Node GetDefaultCFG(){
  ...
  default_config["BACKBONE"] = backbone;

  //FPN
  YAML::Node fpn;
  //fpn["USE_GN"] = false;
  fpn["USE_RELU"] = false;
  default_config["FPN"] = fpn;
...
//   group_norm["EPSILON"] = 1e-5;
  ...
  default_config["ROI_HEADS"] = roi_heads;
  ...
  default_config["ROI_BOX_HEAD"] = roi_box_head;
  ...
  default_config["ROI_MASK_HEAD"] = roi_mask_head;
