...
int main(int argc, char *argv[], char *envp[]) {
  ...
  // rcnn::utils::jit_to_cpp<rcnn::utils::VoVNetMapper>("../python_utils", argv[1], std::vector<std::string>{"backbone.pth", "bbox_pred.pth", "cls_score.pth", "extractor_fc6.pth", "extractor_fc7.pth", "rpn_bbox.pth", "rpn_conv.pth", "rpn_logits.pth"});
