...
void conv3x3(torch::nn::Sequential& seq, int64_t in_channels, int64_t out_channels, std::string module_name, std::string postfix, int64_t stride = 1, int64_t groups = 1, int64_t kernel_size = 3, int64_t padding = 1);
void conv1x1(torch::nn::Sequential& seq, int64_t in_channels, int64_t out_channels, std::string module_name, std::string postfix, int64_t stride = 1, int64_t groups = 1, int64_t kernel_size = 1, int64_t padding = 0);
